...
Generate content for section `section-05-hierarchy-analysis` (filename: `section-05-hierarchy-analysis.md`).
...
for `section-05-hierarchy-analysis` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-05-hierarchy-analysis.md`
