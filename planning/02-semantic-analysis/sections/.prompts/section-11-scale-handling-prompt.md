...
Generate content for section `section-11-scale-handling` (filename: `section-11-scale-handling.md`).
...
for `section-11-scale-handling` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-11-scale-handling.md`
