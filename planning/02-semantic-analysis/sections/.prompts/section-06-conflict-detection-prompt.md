...
Generate content for section `section-06-conflict-detection` (filename: `section-06-conflict-detection.md`).
...
for `section-06-conflict-detection` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-06-conflict-detection.md`
