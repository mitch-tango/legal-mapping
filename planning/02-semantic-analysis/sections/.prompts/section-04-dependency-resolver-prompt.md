...
Generate content for section `section-04-dependency-resolver` (filename: `section-04-dependency-resolver.md`).
...
for `section-04-dependency-resolver` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-04-dependency-resolver.md`
