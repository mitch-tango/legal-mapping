...
Generate content for section `section-01-schema-and-fixtures` (filename: `section-01-schema-and-fixtures.md`).
...
for `section-01-schema-and-fixtures` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-01-schema-and-fixtures.md`
