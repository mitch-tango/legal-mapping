...
Generate content for section `section-08-conditions-precedent` (filename: `section-08-conditions-precedent.md`).
...
for `section-08-conditions-precedent` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-08-conditions-precedent.md`
