...
Generate content for section `section-03-staleness-tracking` (filename: `section-03-staleness-tracking.md`).
...
for `section-03-staleness-tracking` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-03-staleness-tracking.md`
