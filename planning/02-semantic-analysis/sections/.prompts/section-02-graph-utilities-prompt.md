...
Generate content for section `section-02-graph-utilities` (filename: `section-02-graph-utilities.md`).
...
for `section-02-graph-utilities` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\02-semantic-analysis/sections/section-02-graph-utilities.md`
