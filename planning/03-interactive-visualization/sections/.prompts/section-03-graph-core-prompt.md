...
Generate content for section `section-03-graph-core` (filename: `section-03-graph-core.md`).
...
for `section-03-graph-core` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\03-interactive-visualization/sections/section-03-graph-core.md`
