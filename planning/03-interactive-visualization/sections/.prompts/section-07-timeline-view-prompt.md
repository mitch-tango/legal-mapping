...
Generate content for section `section-07-timeline-view` (filename: `section-07-timeline-view.md`).
...
for `section-07-timeline-view` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\03-interactive-visualization/sections/section-07-timeline-view.md`
