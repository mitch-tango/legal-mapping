...
Generate content for section `section-09-polish` (filename: `section-09-polish.md`).
...
for `section-09-polish` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\03-interactive-visualization/sections/section-09-polish.md`
