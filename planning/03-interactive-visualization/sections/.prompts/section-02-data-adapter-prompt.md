...
Generate content for section `section-02-data-adapter` (filename: `section-02-data-adapter.md`).
...
for `section-02-data-adapter` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\03-interactive-visualization/sections/section-02-data-adapter.md`
