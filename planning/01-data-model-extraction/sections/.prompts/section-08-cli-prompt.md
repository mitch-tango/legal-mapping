...
Generate content for section `section-08-cli` (filename: `section-08-cli.md`).
...
for `section-08-cli` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/section-08-cli.md`
