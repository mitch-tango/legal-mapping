...
Generate content for section `section-04-document-readers` (filename: `section-04-document-readers.md`).
...
for `section-04-document-readers` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/section-04-document-readers.md`
