...
Generate content for section `section-06-pipeline` (filename: `section-06-pipeline.md`).
...
for `section-06-pipeline` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/section-06-pipeline.md`
