...
Generate content for section `section-03-extraction-models` (filename: `section-03-extraction-models.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/claude-plan.md` - Full implementation plan
2. `C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-extraction-models` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/section-03-extraction-models.md`
