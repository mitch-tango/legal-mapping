...
Generate content for section `section-05-prompts` (filename: `section-05-prompts.md`).
...
for `section-05-prompts` to understand what this section should contain.
...
`C:\Users\maitl\New City Dropbox\Maitland Thompson\Working\Legal Review\Mapping\planning\01-data-model-extraction/sections/section-05-prompts.md`
